...
class ImageAsNetEngine(engine.Engine):
    ...
    def __init__(self, datamanager, model, optimizer, margin=0.3,
                 ...
                 label_smooth=True):
        super(ImageAsNetEngine, self).__init__(datamanager, model, optimizer, scheduler, use_gpu)
        ...
        self.criterion_c = CenterLoss(num_classes=751, feat_dim=2048*(1+self.num_parts)) #20191221_1
    ...
    def train(self, epoch, max_epoch, trainloader, fixbase_epoch=0, open_layers=None, print_freq=10):
        ...
        for batch_idx, data in enumerate(trainloader):
            ...
            loss = self.weight_x * loss_x + self.weight_t * loss_t + 0.0005 / (1.0+self.num_parts) * loss_c
            loss.backward()
            self.optimizer.step()
            ...
            if self.writer is not None:
                ...
                self.writer.add_scalar('Train/Acc1', accs.avg, n_iter)
