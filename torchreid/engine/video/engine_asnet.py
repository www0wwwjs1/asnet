...
import torchreid
from torchreid.engine.image import ImageAsNetEngine
from torchreid.engine.video import VideoSoftmaxEngine


class VideoAsNetEngine(ImageAsNetEngine, VideoSoftmaxEngine):
    ...
    def __init__(self, datamanager, model, optimizer, margin=0.3,
        ...
        super(VideoAsNetEngine, self).__init__(datamanager, model, optimizer, margin=margin,
